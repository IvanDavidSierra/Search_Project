        ...
        <div class="cartas-seminarios" style="font-family: Lustria;">
            <div class="card">
                ...
                <div class="body-cartas">
                    ...
                    <a href="SeminarioPlantilla.php? IdSeminarios=<?php echo $IdS ?>" style="color: white; text-decoration: none;"><button style="background-color: #0F1D5D; padding: 8px 8px; border-radius: 8px; text-decoration: none;"> Ver proyectos </a></button>
                    </div>
                </div>
